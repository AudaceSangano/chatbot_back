...
GEMINI_API_KEY = "AIzaSyCkq_F2wYgEjxf4A1jEK4y_Fu138exW9t0"
...
def get_gemini_response(user_input):
    ...
    prompt = context + user_input + ", summarize and use single sentence."
...
def chatbot_response(user_input, dialogues):
    ...
    return (gemini_response, None)  # No confidence for Gemini
